...
- Оцениваем собранные доказательства через вопросы: _“Насколько сильно полученные данные противоречат $H_{0}$?
  Достаточно ли силы у полученных данных, чтобы опровергнуть $H_{0}$?”_